...
package: nrf52840_xxaa
	@echo Packaging: nrf52840_xxaa
...
flash: package
	@echo Flashing: $(OUTPUT_DIRECTORY)/nrf52840_xxaa
	nrfutil dfu serial -p $(PORT) -pkg $(OUTPUT_DIRECTORY)/nrf52840_xxaa.zip
